...
class ObjectDetector:
    def __init__(self):
        ...
        self.prediction_horizon = 1.0  # Predict 1 second into the future
        self.n_prediction_points = 20  # Number of points to use in prediction curve
        self.min_points_for_prediction = 5  # Minimum points needed before making prediction
        
        # Keep your existing subscribers
        ...
        # Add timer for periodic trajectory plotting
        self.plot_timer = rospy.Timer(rospy.Duration(5.0), self.plot_trajectory)
        
        rospy.spin()

    # Keep existing callbacks the same
    ...
    def predict_trajectory(self):
        ...
        try:
            # Fit quadratic functions for each coordinate (assuming parabolic motion)
    ...
    def plot_trajectory(self, event=None):
        ...
        # If we have a prediction, add the predicted end point
        if x_pred is not None:
